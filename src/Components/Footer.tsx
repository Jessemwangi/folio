const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gray-100 dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 mt-12">
      <div className="container mx-auto max-w-5xl px-4 py-6 flex flex-col sm:flex-row items-center justify-between">
        
        {/* Copyright Information */}
        <p className="text-sm text-gray-600 dark:text-gray-400 text-center sm:text-left mb-4 sm:mb-0">
